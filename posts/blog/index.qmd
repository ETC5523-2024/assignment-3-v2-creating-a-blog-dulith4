...
date: "2024-09-25"
categories: [Blog, Christmas, Kwanzaa, Hanukkah, Movies]
---
...
write_csv(holiday_movies, "data/holiday_movies.csv")

write_csv(holiday_movie_genres, "data/holiday_movies_genres.csv")
...
holiday_movie_genres <- read_csv("data/holiday_movies_genres.csv")
...
- tidytuseday. 2023.tidytuesday/data/2023/2023-12-12 at master · rfordatascience/tidytuesday. [online] GitHub. Available at: https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-12-12 [Accessed 25 Sep. 2024].
